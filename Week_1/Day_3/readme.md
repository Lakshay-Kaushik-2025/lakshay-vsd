...
Follow the steps from [Day 1 Synthesis Lab](https://github.com/Lakshay-Kaushik-2025/lakshay-vsd/edit/main/Week_1/Day_1#6-synthesis-lab-with-yosys) and add the following between `abc -liberty` and `synth -top`:
```shell
opt_clean -purge
```
