# SoC Designing
This project focuses on the design of a compact, open-source System-on-Chip (SoC) built around RVMYTH, a RISC-V processor core. The SoC incorporates a Phase-Locked Loop (PLL) for precise clock generation and management, as well as a 10-bit Digital-to-Analog Converter (DAC) to enable communication with external analog systems. By converting digital signals into analog outputs, the DAC allows the SoC (BabySoC) to interface with devices such as televisions and mobile phones, supporting functionalities like audio and video output. Implemented using Sky130 technology, this SoC is developed as a well-documented educational platform for experimentation and learning in digital-analog interfacing.
<details>
